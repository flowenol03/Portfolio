    ...
    <section id="hero" className="Hero">
      ...
      <div className="Hero-content">
        ...
        <div className="Hero-text">
          ...
          <p>I have a solid foundation in HTML, CSS, JavaScript, and Bootstrap. My goal is to bring designs to life with clean, efficient code and create user-friendly interfaces that stand out.</p>
