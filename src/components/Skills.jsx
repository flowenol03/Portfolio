...
const skills = [
    ...
    {
        name: 'Generative AI',
        icon: 'https://cdn-icons-png.flaticon.com/512/4341/4341139.png', // White AI icon
        description: 'Building solutions using generative AI models.',
        level: 80,
    },
    {
        name: 'Hugging Face',
        icon: 'https://cdn.simpleicons.org/huggingface/white', // White version
        description: 'Utilizing state-of-the-art NLP/ML models.',
        level: 78,
    },
    {
        name: 'DALL·E',
        icon: 'https://cdn-icons-png.flaticon.com/512/4341/4341025.png', // White paint palette icon
    ...
    {
        name: 'LLM',
        icon: 'https://cdn-icons-png.flaticon.com/512/1055/1055687.png', // White AI brain icon
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 w-full max-w-7xl px-4">
                {skills.map((skill, index) => (
                    <motion.div
                        ...
                        className="flex" // Added flex to help with equal height
                    >
                        <Tilt tiltMaxAngleX={10} tiltMaxAngleY={10} className="w-full">
                            <div className="bg-gray-900/70 border-2 border-purple-500 rounded-2xl p-6 text-center shadow-xl hover:shadow-purple-500/50 transition-all duration-300 h-full flex flex-col">
                                <div className="flex-grow"> {/* Content wrapper that grows */}
                                    <img
                                        src={skill.icon}
                                        alt={skill.name}
